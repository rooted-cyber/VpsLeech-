...
RUN cd Vps*;ls;wget -q https://github.com/rooted-cyber/VpsLeech-/raw/master/config.env;wget -q https://github.com/rooted-cyber/anasty-bot/raw/main/token.pickle
